...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="card">
            ...
            <div class="card-body ">
                <ul>
                    <li>Συνολικός Αριθμός Μαθημάτων: {{$data['n_perasmena'] + $data['n_xrostoumena']}}</li>
                    <li>Συνολικός Περασμένων Μαθημάτων:  {{$data['n_perasmena']}}</li>
                    <li>Συνολικός Χρωστούμενων Μαθημάτων: {{$data['n_xrostoumena']}}</li>
